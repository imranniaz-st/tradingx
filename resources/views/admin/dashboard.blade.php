        ...
        <div
            ...
            <div class="w-full">
                ...
                <div class="w-full flex items-center justify-between">
                    <div>
                        <div class="mb-1">
                            <p class=" font-bold text-gray-500">Deposits</p>
                        </div>
        ...
        <div
            ...
            <div class="w-full">
                ...
                <div class="w-full flex items-center justify-between">
                    <div>
                        <div class="mb-1">
                            <p class=" font-bold text-gray-500">Withdrawals</p>
                        </div>
                ...
                <div class="w-full flex items-center justify-between mb-2">
                    ...
                    <div class="flex items-center space-x-1">
                        ...
                        <div class="flex text-green-500 ts-gray-3 px-2 py-1 rounded-full hover:scale-110 transition-all">
                            ...
                            <span>{{ number_format(($profit_fig / ($capital + 0.001)) * 100 ?? 0, 2) }}%</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="w-full mb-2 lg:flex justify-between lg:space-x-3 lg:gap-3">
                <div class="w-full  ts-gray-2 rounded-lg p-3 mb-5">
                    <div class="w-full flex justify-between items-center">
                        ...
                        <a class="border-b-2 text-xs hover:scale-110 transition-all" href="{{ route('admin.bots.index') }}">View All</a>
                ...
                <div class="w-full  ts-gray-2 rounded-lg p-3 mb-5">
                    <div class="w-full flex justify-between items-center">
                        ...
                        <a class="border-b-2 text-xs hover:scale-110 transition-all"
                            href="{{ route('admin.bots.index') }}">View All</a>
        ...
        <div class="w-full mb-2 lg:flex justify-between lg:space-x-3 lg:gap-3">
            ...
            <div class="w-full ts-gray-2 rounded-lg p-3 mb-5">
                <div class="w-full flex justify-between items-center">
                    ...
                    <a class="border-b-2 text-xs hover:scale-110 transition-all"
                        href="{{ route('admin.deposits.index') }}">View All</a>
                </div>
            ...
            <div class="w-full ts-gray-2 rounded-lg p-3 mb-5">
                <div class="w-full flex justify-between items-center">
                    ...
                    <a class="border-b-2 text-xs hover:scale-110 transition-all"
                        href="{{ route('admin.withdrawals.index') }}">View All</a>
                </div>
